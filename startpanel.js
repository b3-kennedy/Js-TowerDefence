...
export default class StartPanel {
    ...
    draw() {
        ...
        Text.boxWrap(this.c, "JavaScript Tower Defence", this.titleTextPos.x, this.titleTextPos.y, this.titleTextPos.width, this.titleTextPos.height, 25, 'black', 25, 'center', 'top');
        Text.boxWrap(
            this.c, 
            "Reach wave 50 to win", 
            this.paragraphPos.x, 
            this.paragraphPos.y, 
